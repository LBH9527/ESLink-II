...
#define STPWHL   	0x4100
#define STPWHH		0x4101
#define BKS		   	0x4104
#define STBK		0x4105
#define ABK	    	0x4106
#define RBKA	   	0x4107
...
uint8_t emu_read_used_stack(uint8_t *data_buf, uint8_t *code_buf);
uint8_t emu_read_all_stack(uint8_t *data_buf, uint8_t *code_buf);
...
uint8_t update_chip_status(uint8_t *rd_buf, uint8_t read_len)	;
