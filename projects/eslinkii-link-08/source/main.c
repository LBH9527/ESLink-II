...
{
    flag_send(task_flags, FLAGS_ICD_DEBUG);
}
...
//            }              
//#endif         
            if( flag_recv(task_flags, FLAGS_ICD_DEBUG))
            {
                flag_clr(task_flags, FLAGS_ICD_DEBUG);
                debug_process_handle(); 
            }
        }
