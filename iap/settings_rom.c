...
static const cfg_setting_t config_default = {
    ...
    .target_dev.config_start = 0,
    .target_dev.config_size = 0,
...
void config_set_update_app(bool update)
{
    if( update)
        config_rom.update_flag == 0xA5A53377;
}
bool config_get_app_update()
{
    if(config_rom_copy.update_flag == 0xA5A53377)
        return true ;
    else
        return false;
