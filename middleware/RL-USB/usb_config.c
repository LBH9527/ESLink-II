...
//by 9527 for "Custom Class functions" 
//icd定制功能 
...
//(START)       
//字符串描述符索引值 iInterface
#define USBD_EP_NUM_CALC7           MAX((USBD_CLS_ENABLE    *(USBD_CLS_EP_BULKIN    )), (USBD_CLS_ENABLE    *(USBD_CLS_EP_BULKOUT)))
...
//(START)       
//字符串描述符索引值 iInterface
#define USBD_CLS_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_MSC_ENABLE)       
//(END)
