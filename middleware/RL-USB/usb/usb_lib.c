...
const U16 usbd_cls_buf_sz = USBD_CLS_WMAXPACKETSIZE;


U8 USBD_CLS_BulkBuf[USBD_CLS_WMAXPACKETSIZE];
...
//(down)
const U8 WINUSBD_StringDescriptor[USBD_LEN_OS_DESC] = {
    USBD_LEN_OS_DESC,
...
//    USBD_MSC_IF_NUM, 0x01, "WINUSB", {0}, {0}, 
    USBD_CLS_IF_NUM, 0x01, "WINUSB", {0}, {0}, 
//    0x02, 0x01, "WINUSB", {0}, {0}, 
};
// ^^^^ This must match your interface numbera
...
USBD_ExtPropertiesDescStruct USBD_ExtPropertiesDesc = { 
    ...
    0x0100, 0x0005, 0x0001,\
    
    0x00000084, 0x00000001, 0x0028,  \
    {'D','e','v','i','c','e','I','n','t','e','r','f','a','c','e','G','U','I','D',0},\
    0x0000004E, \
    {'{','F','7','0','2','4','2','C','7','-','F','B','2','5','-','4','4','3','B', \
