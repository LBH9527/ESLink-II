...
/* USB Device CDC ACM class user functions                                    */
//extern int32_t  USBD_CLS_PortInitialize(void);
//extern int32_t  USBD_CLS_DataSend(const uint8_t *buf, int32_t len);
//extern int32_t  USBD_CLS_DataFree(void);
//extern int32_t  USBD_CLS_PutChar(const uint8_t  ch);
//extern int32_t  USBD_CLS_DataRead(uint8_t *buf, int32_t len);
//extern int32_t  USBD_CLS_GetChar(void);
//extern int32_t  USBD_CLS_DataAvailable(void);
#ifdef __cplusplus
}
#endif
