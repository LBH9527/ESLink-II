...
//                    }
                    ...
                    if(USBD_SetupPacket.wValueL == 0xEE){
                        pD = (U8 *)WINUSBD_StringDescriptor;
                    }
                    //--------------------------------------- 
...
//                        if (USBD_EndPoint0_Setup_CLS_ReqToIF()) {
//                            goto setup_class_ok;
//                        }
                        goto stall;                                                  /* not supported */
...
setup_class_ok:                                                          /* request finished successfully */
            ...
            case REQUEST_VENDOR:
                switch (USBD_SetupPacket.bmRequestType.Recipient) {
                    case REQUEST_TO_DEVICE:
                        switch (USBD_SetupPacket.wIndexL){
                            case 0x04:
                                USBD_EP0Data.pData = (U8 *)&USBD_CompatIDDesc;
                    ...
                    case REQUEST_TO_INTERFACE:
                         switch (USBD_SetupPacket.wIndexL){
                            ...
                            case 0x05:
                                USBD_EP0Data.pData = (U8 *)&USBD_ExtPropertiesDesc;   
                                break;     
                            default:
                                break;
                        }
